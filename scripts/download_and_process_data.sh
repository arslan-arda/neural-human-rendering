...
DATASET_DIR=E:/neural/
mkdir $DATASET_DIR

FACE_DIR=$DATASET_DIR/face
python face_data_downloader.py -d compressed -o $DATASET_DIR --not_altered --not_mask --sample_only
...
python face_data_processor.py --videos_dir $FACE_DIR
